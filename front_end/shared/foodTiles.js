...
<View>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Fast Food')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Healthy')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Pizza')} >
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Sushi')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Seafood')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Chicken')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('American')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Breakfast')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Mexican')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Chinese')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Italian')}>
    ...
    <View style={styles.card}> 
        <TouchableOpacity style={styles.button} onPress={() => props.foodTilePress('Spanish')}>
